<div class="form-box">
    <form method="post" action="{{route("clearance.store")}}">
        {{ csrf_field() }}
        <div class="row">
        <div class="col-md-12">
            <div class="form-group">
                <label for="name">Title</label>
                <input id="name" type="text" name="name" class="form-control" placeholder="Clearance Section Title" required>
                @error('name')
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-control" placeholder="Enter Instructions" required></textarea>
                @error('description')
                <span class="invalid-name" role="alert">
                        <strong class="text-danger">{{ $message }}</strong>
                    </span>
