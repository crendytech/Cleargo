<div class="form-box">
    <form method="POST" enctype="multipart/form-data" action="{{route("profilepics.save")}}">
        @csrf
        <div class="row">
        <div class="form-group col-12">
            <div class="float-left col-4">
                <label for="document" class="float-left pt-1 form-control-label">Upload Pics <span class="text-danger">* (.jpg, .png, .jpeg)</span> </label>
            </div>
